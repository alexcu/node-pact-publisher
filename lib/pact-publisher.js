  ...
  return Q.Promise(function (resolve, reject) {
    request({
      ...
      try {
        ...
        return reject("Error parsing expected JSON pacticipant response: " + e.message);
      }
...
/**
 * Registers a pacticipant with the broker
 * @param  {String} name Pacticipant name to check
 * @return {Promise}     Promise to if the pact was registered
 */
PactPublisher.prototype.registerPacticipant = function (name) {
  var self = this;
  return Q.Promise(function (resolve, reject) {
    request({
      uri: self._pactBrokerBaseUrl + "/pacticipants",
